...
namespace TFT_API.Persistence
{
    public class GuideRepository(TFTContext context) : IGuideDataAccess
    {
        ...
        // Adds a new user guide to the database and returns the mapped UserGuideDto
        ...
        // Gets a list of user guides, sorted by the specified criteria
        ...
        // Gets user guides created by a specific user
        ...
        // Gets user guides that have comments from a specific user
        ...
        // Gets user guides that have been upvoted by a specific user
        ...
        // Gets user guides that have been downvoted by a specific user
        ...
        // Gets a full user guide by its ID, including related entities
        ...
        // Gets a user guide by its ID, returning it as UserGuideDto
        ...
        // Updates an existing user guide and returns the updated UserGuideDto
        ...
        // Gets a list of auto-generated user guides
        ...
        // Gets a dictionary of user votes for a specific user
        ...
        // Projects a query of UserGuide entities to FeedUserGuideDto objects 
        ...
        // Projects a query of UserGuide entities to UserGuideDto objects
        ...
        // Projects a query of UserGuide entities to AutoGeneratedGuideDto objects
        private static IQueryable<AutoGeneratedGuideDto> ProjectToAutoGeneratedGuideDto(IQueryable<UserGuide> query)
        {
            return query.Select(ug => new AutoGeneratedGuideDto
            {
                Id = ug.Id,
                UpVotes = ug.UpVotes,
                InitialUnit = ug.InitialUnit != null ? new GuideUnitDto
                {
        ...
        // Maps a UserGuide entity to UserGuideDto
