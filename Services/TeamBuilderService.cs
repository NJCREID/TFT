...
namespace TFT_API.Services
{
    public class TeamBuilderService(TFTContext context, IConfiguration configuration, IMemoryCache memoryCache)
    {
        ...
        {
            _units = await _context.Units.Include(u => u.Traits).ToListAsync();
        ...
        private async Task<List<UserGuide>> GenerateGuides()
        {
            ...
            foreach (var unit in _units)
            {
                ...
                CalculateStatsForMatches(unitMatches, unit.InGameKey);
        ...
        private void CalculateStatsForMatches(List<Match> matches, string inGameKey)
        {
